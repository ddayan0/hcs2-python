# Dennis Dayan
# ClassProject.py
#happy whatever time of day it is Mr. Watson

import logging #this is where my logging goes into a state of mind known as "sicko mode"
logging.basicConfig(filename='debug3.txt', level=logging.DEBUG, #defines debug file where errors would be stored
                    format='%(asctime)s %(levelname)s %(name)s %(message)s') #format the errors are written in
logger=logging.getLogger(__name__) #imma be real with you Mr. Watson, I have no idea what this does other then help the logger actually function.
try:
    import time
    ...
    \|___|/
        ...
        def milofight(self):#final boss fight with Mr. Milonas
            ...
            if miloinp == 'attack' or miloinp == 'Attack':
                ...
                time.sleep(1.5)
                print("ADAS IRWIN LINK: INITIATE MORPHING SEQUENCE!") #MR WILKINS IS ABOUT TO DESTROY MR. MILONAS WITH FACTS AND LOGIC(not really)
                time.sleep(1.5)
                ...
                print("ADAS IRWIN LINK: MY HUMBLE KNIGHT AND STUDENT, THANK YOU FOR DEFENDING THESE SACRED WALLS. MY KNIGHT, HEAL.")
                ...
                time.sleep(1.5)
                print("ADAS IRWIN LINK: MY KNIGHT, I MUST GO. I CANNOT ROAM THESE HALLS AS FOR THE SIGHT OF MY RAW POWER TO A FRESHMAN WOULD SURELY DECIMATE THEM.")
                time.sleep(1.5)
        ...
        def watsonfightenter2(self): #SEE ABOVE wastonfightenter, walkbywatson, watsonrun, milofight comments, as this segment is duplicated.
            print('YOU SEE CHRISTOPHER WATSON WITH A BASKETBALL')
            print('---------------------------{}')
        ...
        def watsonfightenter3(self): #SEE ABOVE wastonfightenter, walkbywatson, watsonrun, milofight comments, as this segment is duplicated.
            print('YOU SEE CHRISTOPHER WATSON WITH A BASKETBALL')
            print('---------------------------{}')
            print('CHRISTOPHER WASTON:  HELLO STUDENT, PREPARE TO MEET THY WRATH')
            print('WHAT WILL YOU DO?(Fight, Run)')
        ...
        def watsonfightenter4(self): #SEE ABOVE wastonfightenter, walkbywatson, watsonrun, milofight comments, as this segment is duplicated.
            print('YOU SEE CHRISTOPHER WATSON WITH A BASKETBALL')
            print('---------------------------{}')
            print('CHRISTOPHER WASTON:  HELLO STUDENT, PREPARE TO MEET THY WRATH')
            print('WHAT WILL YOU DO?(Fight, Run)')
    ...
    print('---------------------------------------------------------------DEVELOPER EDITION!---------------------------------------------------------------') #oh man this is the dev edition!!!!
    ...
    ''')
            ...
            if wsusinput == 4:
                import os
                os.startfile('H:/PycharmProjects/FileIO/debug3.txt', )
                Student.play(Student)
                break
            if wsusinput == 5:
                rf = open('debug3.txt', 'r')
                debuglog = rf.read()
                print(debuglog)
                print('----------------These are previous erors! You need to choose option four for live error reporting!----------------\n')
                print('-STARTING GAME!-')
                rf.close()
                Student.play(Student)
                break
